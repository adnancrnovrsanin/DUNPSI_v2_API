...
namespace Persistence.Migrations
{
    ...
    [Migration("20240918203243_ImplementigRating")]
    partial class ImplementigRating
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("51a08ca5-fc28-4b05-a317-cecb4c381b73"),
                            AppUserId = "648be0e8-f17c-4df2-a94d-a9c2142d6c1c"
                        });
                });
            ...
            modelBuilder.Entity("Domain.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "648be0e8-f17c-4df2-a94d-a9c2142d6c1c",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c7be3a00-5b68-4af4-99ea-9371dde2865f",
                            Email = "admin@example.com",
                            EmailConfirmed = true,
                            LastActive = new DateTime(2024, 9, 18, 20, 32, 39, 445, DateTimeKind.Utc).AddTicks(8407),
                            LockoutEnabled = false,
                            Name = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAED6tHcLGkMMYmnMiaF0Yf+jd2ZrFD+E9sJvTcthJyQdEupSLJ361AfozDHbkbHHxfQ==",
                            PhoneNumberConfirmed = false,
                            Role = 0,
                            SecurityStamp = "322a7967-5e74-4ef3-899b-11befda4ed16",
                            Surname = "Admin",
            ...
            modelBuilder.Entity("Domain.Rating", b =>
                {
                    ...
                    b.HasOne("Domain.Requirement", "Requirement")
                        ...
                        .HasForeignKey("Domain.Rating", "RequirementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
