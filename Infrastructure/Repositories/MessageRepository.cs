    ...
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            query = messageParams.Container switch
            {
                ...
                _ => query.Where(u => u.RecipientEmail == messageParams.Email 
        ...
        public async Task<int> CountUnreadMessagesForUser(string email)
        {
            return await _context.Messages
                .CountAsync(u => u.RecipientEmail == email && u.RecipientDeleted == false && u.DateRead == null);
        }
        ...
        public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentEmail, string recipientEmail)
        {
            var query = _context.Messages
                .Where(
                    m => m.RecipientEmail == currentEmail && m.RecipientDeleted == false &&
                    m.SenderEmail == recipientEmail ||
                    m.RecipientEmail == recipientEmail && m.SenderDeleted == false &&
